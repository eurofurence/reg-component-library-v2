...
import {
	...
	WithFormHeaderLabelWrappedComponentProps,
	withFormHeaderLabel,
...
> = WithFormHeaderLabelProps<PlainSelectProps<Option, IsMulti>>
	...
	const BSelect = withFormHeaderLabel<never, PlainSelectProps<Option, IsMulti>>(
		forwardRef<
			...
			WithFormHeaderLabelWrappedComponentProps<
				PlainSelectProps<Option, IsMulti>
			>
		>((forwardRefProps, _ref) => (
			<BaseSelect<Option, IsMulti> {...forwardRefProps} />
		))
	)
